...
public class DuringFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (disTitle.equals("Earthquakes")) {
            plan1.setText(R.string.duringep1);
            plan2.setText(R.string.duringep2);
            plan3.setText(R.string.durinep3);
            plan4.setText(R.string.duringep4);
            plan5.setText(R.string.duringep5);
            plan6.setText(R.string.duringep6);
